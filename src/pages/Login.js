...
export default function Login() {
  ...
  window.addEventListener("scroll", change);
    ...
    return (
        ...
        {
    loader ?
   <div className={styles.loader}><PacmanLoader  size={20} color={'#FF8080'}  loading={loader} /></div>
    :
    <div>
     <div className={styles.one}>
                <div className={nav? styles.nav1_active:styles.nav1}>
                 <div className={nav? styles.logo1:styles.logo}>
                         ...
                         <Link to="/login"><button className={nav? styles.btn1 :styles.btn2}>Kirish</button></Link>                        
                        </div>    
                    </div>
                </div>  
                    </div> 
                ...
                <div className={nav? styles.nav1_active:styles.nav1}>
                 <div className={nav? styles.logo1:styles.logo}>
                        ...
                        <FaBars onClick={openNav} style={{color:'#FF8080',fontSize:'30px'}}/>    
                         </div>   
                         ...
                         <Menu
                            ...
                            <AiOutlineClose onClick={closeNav} style={{fontSize:'30px', color:'white'}}/>
                            </div>
                    </div>
                </div>  
                ...
                <Row>
                    <Col lg={12} className={styles.text}>
                        ...
                        <Form>
                           ...
                           <Button onClick={login} type="submit" style={{fontWeight:'600',backgroundColor:'#FF8080',border:'none',marginTop:'30px',width:'100%'}}>
                               Kirish
                           </Button>
                           </Form>
                        </div>
