            ...
            <div>
                ...
                <div className={this.state.nav? styles.nav1_active:styles.nav1}>
                 <div className={this.state.nav? styles.logo1:styles.logo}>
                         ...
                         <span><BsFillTriangleFill className={styles.icon1}/></span>
                           ...
                           <p><Link to="/tarbiyachilar/uz">Tarbiyalovchilar</Link></p>
                ...
                <div className={this.state.nav? styles.nav1_active:styles.nav1}>
                 <div className={this.state.nav? styles.logo1:styles.logo}>
                        ...
                        <FaBars onClick={this.openNav} style={{color:'#F76B6A',fontSize:'30px'}}/>    
                         </div>   
                            ...
                            >
                             ...
                             <span><Link to="/dashboard/uz"><FaHome style={{color:'white',fontSize:'23px'}}/></Link></span> 
                                ...
                                <Menu.ItemGroup key="g1" style={{borderTop:'3px solid rgba(0,0,0,0.4)'}}>
                                    ...
                                    <Menu.Item key="4"><Link to="/tarbiyachilar/uz">Tarbiyalovchilar</Link></Menu.Item>
