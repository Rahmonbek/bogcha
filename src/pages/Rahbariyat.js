 ...
 <header>
             ...
             <body>
               <div className={styles.body}>
                   <div data-aos="fade-up" className={styles.title}><h1>Rahbariyat</h1></div>
                   <Row>
                       <Col lg={12}>
      ...
      <MDBRow className='g-0'>
        ...
        <MDBCol md='6' style={{paddingLeft:'20px', }}>
          <MDBCardBody >
            <MDBCardTitle><h1 className={styles.title1} >Direktor</h1></MDBCardTitle>
            <MDBCardText>
      ...
      <MDBCol md='6' style={{paddingLeft:'20px', }}>
          <MDBCardBody>
            <MDBCardTitle><h1 className={styles.title1} >Direktor o'rin bosari</h1></MDBCardTitle>
            <MDBCardText>
            <p><strong>F.I.O: </strong>Abdurahmonova Shohida Abdumalik qizi</p>
            <p><strong>Tug'ilgan sana: </strong> <i style={{color:'#FF8080'}} class="fas fa-calendar-alt"></i> 06/12/1995</p>
            <p><strong>Mutaxasislik: </strong>Ingliz tili mutaxasisi</p>
      ...
      <MDBCol md='6' className={styles.container}>
        ...
        <MDBCol md='6' style={{paddingLeft:'20px', }}>
          <MDBCardBody>
            <MDBCardTitle><h1 className={styles.title1} >Bosh buxgalter</h1></MDBCardTitle>
            <MDBCardText>
            <p><strong>F.I.O: </strong>Abdurahmonova Shohida Abdumalik qizi</p>
            <p><strong>Tug'ilgan sana: </strong> <i style={{color:'#FF8080'}} class="fas fa-calendar-alt"></i> 06/12/1995</p>
            <p><strong>Mutaxasislik: </strong>Ingliz tili mutaxasisi</p>
