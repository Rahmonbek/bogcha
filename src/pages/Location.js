         ...
         <div className={styles.one}>
                ...
                <div className={this.state.nav? styles.nav1_active:styles.nav1}>
                 <div className={this.state.nav? styles.logo1:styles.logo}>
                        ...
                        <FaBars onClick={this.openNav} style={{color:'#FF8080',fontSize:'30px'}}/>    
                         ...
                         <div className={this.state.open? styles.navWrapper1:styles.navWrapper}>
             ...
             <body>
               <div className={styles.body} style={{overflowY:'hidden'}}>
                   <div className={styles.title}><h1>Joylashuv</h1></div>
                   <div className={styles.content}>
                       <Row>
                         <Col lg={4} className={styles.footer} style={{height:'700px'}}>
                  ...
                  <img src={rasm1}/>
                   ...
                   <div className={styles.aloqa}>
                     <p>
                     <span><img src={aloqa4}/></span>
                       <a href='tel:972-238-7833'>972-238-7833</a>
                     </p>
                       
                      
                     <p>
                     <span><img src={aloqa3}/></span>
                       <a href='mailto: karshiyeva.nilufar6789@gmail.com'>karshiyeva.nilufar@gmail.com</a>
                     </p>
                      
                      
                       <p>
                       <span><img src={aloqa2}/></span>
                       <a href='972-238-7672'>972-238-7672</a>
                       </p>
                      
                   </div>
                   <div className={styles.adres}>
                       <span><img src={aloqa1}/></span>
                       <a href='1402 Blake Dr. Richardson TX 75081'> Amir Temur shox ko'chasi, 13-uy</a>
