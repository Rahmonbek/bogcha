...
function App() {
  return (
    <BrowserRouter>    
      ...
      <Route exact path="/dashboard/uz"><Dashboard/></Route>
      <Route exact path="/loving/uz"><Loving/></Route>
      <Route exact path="/wonder/uz"><Wonder/></Route>
      <Route exact path="/leadership/uz"><Leadership/></Route>
      <Route exact path="/changing/uz"><Changing/></Route>
      <Route exact path="/manzil/uz"><Location/></Route>
      ...
      <Route exact path="/garden/uz"><Garden/></Route>
      ...
      <Route exact path="/tadbir/uz"><Tadbir/></Route>
      <Route exact path="/rahbariyat/uz"><Rahbariyat/></Route>
